...
class PreTrainedBertModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name, *inputs, **kwargs):
        ...
        """
        if pretrained_model_name in archived_pretrained_map_model:
            archive_file = archived_pretrained_map_model[pretrained_model_name]
        else:
        ...
        try:
            ...
            logger.error(
                ...
                "associated to this path or url.".format(
                    ...
                    ', '.join(archived_pretrained_map_model.keys()),
                    pretrained_model_name))
            return None
